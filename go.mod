module github.com/digilolnet/caddy-bunny-ip

go 1.21.4

require (
	github.com/caddyserver/caddy/v2 v2.7.5
	github.com/digilolnet/bunnynetedgeips v0.0.0-20231129192711-c317e7b8f5ed
)
...
require (
	...
	github.com/PatrickCronin/routesum v0.2.0 // indirect
